    ...
    while True:
        ...
        for source in historical_urls:
            ...
            if metadata_cursor.count() == 0:
                ...
                feed_count[source + "(HISTORICAL)"] = crawlAndScrape(source,
                                                                     robots_url
                                                                     )
                ...
                logging.info("Historical data already exists for " + source)
...
def scrapeAndSave(feedName, feedURL):
    """visual scraping done for sites without RSS/Sitemap/API (Finviz)."""
